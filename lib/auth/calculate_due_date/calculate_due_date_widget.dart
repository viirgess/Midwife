...
import 'calculate_due_date_model.dart';
export 'calculate_due_date_model.dart';

class CalculateDueDateWidget extends StatefulWidget {
  const CalculateDueDateWidget({super.key});

  @override
  State<CalculateDueDateWidget> createState() => _CalculateDueDateWidgetState();
}

class _CalculateDueDateWidgetState extends State<CalculateDueDateWidget> {
  late CalculateDueDateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CalculateDueDateModel());
            ...
            child: Column(
              ...
              children: [
                ...
                if ((_model.datePicked != null) &&
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(34.0, 32.0, 34.0, 0.0),
                    child: Container(
                      width: 100.0,
                      decoration: BoxDecoration(
                        color: FlutterFlowTheme.of(context).primaryBackground,
