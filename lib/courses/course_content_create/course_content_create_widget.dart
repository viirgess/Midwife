...
class CourseContentCreateWidget extends StatefulWidget {
  const CourseContentCreateWidget({
    super.key,
  ...
  @override
  State<CourseContentCreateWidget> createState() =>
      _CourseContentCreateWidgetState();
}

class _CourseContentCreateWidgetState extends State<CourseContentCreateWidget> {
  late CourseContentCreateModel _model;
    ...
    return StreamBuilder<SectionsRecord>(
      stream: SectionsRecord.getDocument(widget.parameter2!)
        ..listen((containerSectionsRecord) async {
          ...
          _model.containerPreviousSnapshot = containerSectionsRecord;
        }),
