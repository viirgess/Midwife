...
class SelectPaymentPlanWidget extends StatefulWidget {
  const SelectPaymentPlanWidget({super.key});

  @override
  State<SelectPaymentPlanWidget> createState() =>
      _SelectPaymentPlanWidgetState();
}

class _SelectPaymentPlanWidgetState extends State<SelectPaymentPlanWidget> {
  late SelectPaymentPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectPaymentPlanModel());
