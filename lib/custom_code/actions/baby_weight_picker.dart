...
Future<double> babyWeightPicker(
  BuildContext context,
  bool isCurrent,
) async {
  // Add your function code here!
  // Add your function code here!
  int _selectedKg = FFAppState().babyCurrentWeight.floor() == 0
      ? 3
      : FFAppState().babyCurrentWeight.floor();
  int _selectedGrams = 40;
  ...
  final kg = CupertinoPicker(
    ...
    onSelectedItemChanged: (int selectedItem) {
      ...
      isCurrent
          ? FFAppState().update(() {
              FFAppState().babyCurrentWeight = _selectedKg +
                  double.parse((_selectedGrams / 100).toStringAsFixed(2));
            })
          : FFAppState().update(() {
              FFAppState().babyInitWeight = _selectedKg +
                  double.parse((_selectedGrams / 100).toStringAsFixed(2));
            });
    },
...
const List<String> kgList = <String>[
  '0',
  '1',
  '2',
  '3',
