                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  20.0, 0.0, 0.0, 22.0),
                              child: Text(
                                '${columnCount.toString()} groups you\'ve joined',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Figtree',
                                ...
                                return FutureBuilder<List<GroupsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return ListView.separated(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listView1GroupsRecordList.length,
                                      ...
                                      itemBuilder: (context, listView1Index) {
                                        final listView1GroupsRecord =
                                            listView1GroupsRecordList[
                                                listView1Index];
                                        return Visibility(
                                          visible: listView1GroupsRecord.members
                                                                ...
                                                                Padding(
                                                                  padding: const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    '${listView1GroupsRecord.members.length.toString()} members • ${containerCount.toString()} posts',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
