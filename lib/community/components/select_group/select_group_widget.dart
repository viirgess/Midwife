...
class SelectGroupWidget extends StatefulWidget {
  const SelectGroupWidget({
    super.key,
    required this.groupRefCallback,
  });

  final Future Function(DocumentReference groupRef)? groupRefCallback;
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, listView1Index) {
                                final listView1GroupsRecord =
                                    listView1GroupsRecordList[listView1Index];
                                return Visibility(
                                        ...
                                        FutureBuilder<int>(
                                          future: queryPostsRecordCount(
                                            queryBuilder: (postsRecord) =>
                                                postsRecord.where(
                                              'group_ref',
                                              isEqualTo: listView1GroupsRecord
                                                  .reference,
                                            ),
                                          ),
                                          builder: (context, snapshot) {
