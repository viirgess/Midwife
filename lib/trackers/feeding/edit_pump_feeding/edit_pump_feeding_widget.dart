...
import '/trackers/feeding/ask_for_deleting_pump_feeding/ask_for_deleting_pump_feeding_widget.dart';
...
import 'edit_pump_feeding_model.dart';
export 'edit_pump_feeding_model.dart';

class EditPumpFeedingWidget extends StatefulWidget {
  const EditPumpFeedingWidget({
    super.key,
  ...
  @override
  State<EditPumpFeedingWidget> createState() => _EditPumpFeedingWidgetState();
}

class _EditPumpFeedingWidgetState extends State<EditPumpFeedingWidget> {
  late EditPumpFeedingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPumpFeedingModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().leftPump =
          _model.trackerRef!.pumpFeedings[widget.index!].leftAmount;
      FFAppState().rightPump =
          _model.trackerRef!.pumpFeedings[widget.index!].rightAmount;
      setState(() {});
    });
                      ...
                      child: TextFormField(
                        controller: _model.textController ??=
                          ...
                          text: optionsTrackersRecord
                              .pumpFeedings[widget.index!].notes,
                        ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget.trackerRef!.update({
                          ...mapToFirestore(
                            {
                              'pump_feedings': getPumpFeedinListFirestoreData(
                                functions.editPumpFeedingAtIndex(
                                    optionsTrackersRecord.pumpFeedings.toList(),
                                    widget.index!,
                                    _model.datePicked,
                          ...
                          builder: (context) {
                            return WebViewAware(
                              child: Padding(
                                ...
                                child: AskForDeletingPumpFeedingWidget(
