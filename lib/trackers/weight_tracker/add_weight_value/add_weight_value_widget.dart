...
import 'add_weight_value_model.dart';
export 'add_weight_value_model.dart';

class AddWeightValueWidget extends StatefulWidget {
  const AddWeightValueWidget({
    super.key,
  ...
  @override
  State<AddWeightValueWidget> createState() => _AddWeightValueWidgetState();
}

class _AddWeightValueWidgetState extends State<AddWeightValueWidget> {
  late AddWeightValueModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddWeightValueModel());
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: (FFAppState().currentWeight < 35.0)
                        ? null
                        : () async {
                                    ...
                                    getWeightFirestoreData(
                                      updateWeightStruct(
                                        WeightStruct(
                                          ...
                                          differenceWithPrevious: double.parse(
