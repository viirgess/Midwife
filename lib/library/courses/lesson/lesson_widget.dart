  ...
  Widget build(BuildContext context) {
    return StreamBuilder<LessonsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final lessonLessonsRecord = snapshot.data!;
                                    ...
                                    child: Stack(
                                      children: [
                                        Align(
                                          ...
                                          child: Text(
                                            'Lesson ${lessonLessonsRecord.order.toString()}',
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: custom_widgets.CourseVideoPlayer(
                                    width: double.infinity,
                                    height: 100.0,
                                    videoPath: lessonLessonsRecord.videoPath,
                                    authRef: currentUserReference!.id,
                                    lessonRef: widget.lessonRef!.id,
                                    courseRef:
                                        lessonLessonsRecord.parentReference.id,
                                  ),
                                ),
                              ),
                            ),
                          ...
                          ].addToEnd(const SizedBox(height: 115.0)),
                        ),
                      ),
                    ),
                  ),
                  Align(
                    ...
                    child: FutureBuilder<int>(
                      future: queryLessonsRecordCount(
                        parent: lessonLessonsRecord.parentReference,
                        queryBuilder: (lessonsRecord) => lessonsRecord.where(
                          'order',
                          isEqualTo: (int var1) {
                            return ++var1;
                          }(lessonLessonsRecord.order),
                        ),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                                          ...
                                          if (rowCount == 1) {
                                            return InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                _model.previouLesson =
                                                    await queryLessonsRecordOnce(
                                                  parent: lessonLessonsRecord
                                                      .parentReference,
                                                  queryBuilder:
                                                      (lessonsRecord) =>
                                                          lessonsRecord.where(
