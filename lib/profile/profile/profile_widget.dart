...
import '/profile/general/ask_delete_account/ask_delete_account_widget.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                        ...
                        child: Builder(
                          builder: (context) {
                            if (valueOrDefault<bool>(
                                currentUserDocument?.babyWasBorn, false)) {
                              return Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: Text(
                              ...
                              return Padding(
                                ...
                                child: AuthUserStreamWidget(
                                  builder: (context) => Text(
                                    '${functions.calculateWeek(currentUserDocument!.calculatedDate!, getCurrentTimestamp).toString()} week, ${functions.getDaysOfPregnancy(getCurrentTimestamp, currentUserDocument!.calculatedDate!).toString()} days',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Figtree',
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(0.0),
                                    child: SvgPicture.asset(
                                      'assets/images/friends_icon.svg',
                                      width: 24.0,
                                      height: 24.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(0.0),
                                    child: SvgPicture.asset(
                                      'assets/images/manage_subscription.svg',
                                      width: 24.0,
                                      height: 24.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(0.0),
                                    child: SvgPicture.asset(
                                      'assets/images/referral_program.svg',
                                      width: 24.0,
                                      height: 24.0,
                                      fit: BoxFit.cover,
                                    ),
                                ...
                                return WebViewAware(
                                  child: GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: const AskDeleteAccountWidget(),
                                    ),
                                  ),
                                );
                              },
                ...
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(20.0, 28.0, 20.0, 0.0),
