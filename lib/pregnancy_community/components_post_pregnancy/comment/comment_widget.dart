...
import '/pregnancy_community/components_post_pregnancy/leave_reply/leave_reply_widget.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<PostPregnancyRepliesRecord>>(
                    stream: queryPostPregnancyRepliesRecord(
                      parent: containerPostPregnancyCommentsForumRecord
                          .parentReference,
                      queryBuilder: (postPregnancyRepliesRecord) =>
                          postPregnancyRepliesRecord
                              .where(
                                'commentRef',
                                isEqualTo:
                                    containerPostPregnancyCommentsForumRecord
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<PostPregnancyRepliesRecord>
                          listViewPostPregnancyRepliesRecordList =
                          snapshot.data!;
                      return ListView.builder(
                        ...
                        itemCount:
                            listViewPostPregnancyRepliesRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewPostPregnancyRepliesRecord =
                              listViewPostPregnancyRepliesRecordList[
                                  listViewIndex];
                          return Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: StreamBuilder<UsersRecord>(
                              stream: UsersRecord.getDocument(
                                  listViewPostPregnancyRepliesRecord
                                      .createdBy!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  ...
                                                  highlightColor:
                                                      Colors.transparent,
                                                  onTap: () async {
                                                    if (listViewPostPregnancyRepliesRecord
                                                            .commentLikes
                                                            .contains(
                                                                currentUserReference) ==
                                                        false) {
                                                      await listViewPostPregnancyRepliesRecord
                                                          .reference
                                                          .update({
                                                        ...mapToFirestore(
                                                          {
                                                  ...
                                                  child: Text(
                                                    ...
                                                    style: FlutterFlowTheme.of(
                                                        ...
                                                        .override(
                                                          fontFamily: 'Outfit',
                                                          color: listViewPostPregnancyRepliesRecord
                                                                      .commentLikes
                                                                      .contains(
                                                                          currentUserReference) ==
                                                                  false
